...
/**
 * @file poisson_serial.cpp
 * @brief Resolución serial de la ecuación de Poisson 2D.
 * Punto de referencia (Baseline) para el cálculo de Speedup.
 */
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Programa: poisson_serial | Tiempo_total: " 
