...
/**
 * @file poisson_sync.cpp
 * @brief Resolución de Poisson 2D con control explícito de hilos y barreras.
 * Utiliza nowait en el for y sincronización manual para el cálculo del error.
 */
...
void solve_poisson(std::vector<std::vector<double>>& T, const std::vector<std::vector<double>>& source, 
