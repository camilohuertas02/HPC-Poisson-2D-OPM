...
make all
```
*Compila todos los archivos fuente dentro de la carpeta `src/` y genera los ejecutables en `bin/`.*
...
make plot_all       # Ejecuta ambas visualizaciones al tiempo
```
*Todas las imágenes resultantes se guardarán en la carpeta `imag/`.*
